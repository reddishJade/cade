...
from cade.coding_agent.registry import build_project_scoped_registry
from cade.coding_agent.tools import ShellSpec, detect_shell
...
def _discover_skills(
    ...
    from cade.harness.skills import SkillRegistry, build_skill_search_dirs
