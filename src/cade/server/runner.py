...
服务端持有唯一的 CadeApp 实例（单一会话）。所有连接的 WebSocket 客户端
...
from cade.harness.security.approval import HITLScope
...
class WebRunHub:
    ...
    def __init__(self, app: CadeApp) -> None:
        self._app = app
    ...
    @property
    def app(self) -> CadeApp:
        return self._app

    def set_app(self, app: CadeApp) -> None:
