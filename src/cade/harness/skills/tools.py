...
from cade.harness.skill_activation import SKILL_ACTIVATION_STATE_TAG
from cade.harness.skills.models import SkillDef, SkillResource
from cade.harness.skills.rendering import xml_escape_attr, xml_escape_content
...
def build_load_skill_tool(
    ...
    def handler(
        input: ToolInput, _on_update: Callable[[str], None] | None = None
    ) -> str:
        name = input.get("name", "")
