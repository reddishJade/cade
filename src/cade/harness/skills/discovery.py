...
from cade.harness.skills.models import SkillReference, SkillResource
...
def build_skill_search_dirs(
    ...
    *,
    ...
    if project_root is not None and trust_project_skills:
        dirs.append(((project_root / ".cade" / "skills").resolve(), 1))
        dirs.append(((project_root / ".agents" / "skills").resolve(), 2))
    home = Path.home()
    dirs.append(((home / ".cade" / "skills").resolve(), 3))
