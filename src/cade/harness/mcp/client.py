...
from cade.harness.agent_runtime.async_worker import IsolatedAsyncWorker
...
class _ErrorLog:
    ...
    def __init__(self) -> None:
        fd, path = tempfile.mkstemp(suffix=".log", prefix="cade-mcp-")
        self._path = path
        self.stream = cast(
...
class McpClient:
    ...
    def __init__(
        ...
        self._worker = IsolatedAsyncWorker(name="cade-mcp-client")
