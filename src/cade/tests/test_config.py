...
from cade.harness.config import CadeRuntimeConfig, _config_from_dict
from cade.harness.execution_env import NetworkAccess, SandboxMode
...
class TestDiscoverRuntimeConfigOAuthFallback:
    ...
    def test_preserves_project_config_api_key(self, tmp_path: Path) -> None:
        ...
        config_file = project_dir / "cade.config.json"
