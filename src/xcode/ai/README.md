...
### 核心类型契约
- **统一流事件 ([events.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/events.py))**：
...
- **标准化配置 ([types.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/types.py))**：
  - `ProviderConfig`：标准化的 Provider 构造参数（`api_key`、`model`、`base_url`、`thinking`、`reasoning_effort` 等）。
- **模型解析与缓存 ([models.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/models.py) / [cache.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/cache.py))**：
...
- **[providers/](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/providers/README.md)**：各大厂商的具体协议适配实现（OpenAI、DeepSeek、ChatGLM、MiMo 等），基于公共基类与编解码器封装。
