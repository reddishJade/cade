...
_MODELS: dict[str, dict[str, Model]] = {
    "openai": {
        ...
        "gpt-5.3-codex": Model(
            ...
            max_tokens=128_000,
            cost=Cost(input=1.75, output=14, cache_read=0.175),
        ),
        "gpt-5.2-codex": Model(
            id="gpt-5.2-codex",
            name="GPT-5.2 Codex",
        ...
        "gpt-5.1-codex": Model(
            ...
            context_window=400_000,
            max_tokens=128_000,
            cost=Cost(input=1.25, output=10, cache_read=0.125),
        ),
        "gpt-5-codex": Model(
            id="gpt-5-codex",
            name="GPT-5 Codex",
        ...
        "codex-mini-latest": Model(
            ...
            max_tokens=100_000,
            cost=Cost(input=1.50, output=6, cache_read=0.375),
        ),
        "chat-latest": Model(
            id="chat-latest",
            name="Chat Latest (Instant)",
            api="openai-responses",
            provider="openai",
            reasoning=False,
            context_window=400_000,
        ...
        "gpt-5.4-nano": Model(
            ...
            context_window=400_000,
            max_tokens=128_000,
            cost=Cost(input=0.20, output=1.25, cache_read=0.02),
        ),
        "gpt-4o": Model(
            id="gpt-4o",
            name="GPT-4o",
            ...
            max_tokens=16_384,
            cost=Cost(input=2.50, output=10, cache_read=1.25),
        ),
        "gpt-4o-mini": Model(
            id="gpt-4o-mini",
            name="GPT-4o Mini",
            ...
            context_window=128_000,
            max_tokens=16_384,
            cost=Cost(input=0.15, output=0.60, cache_read=0.075),
        ),
        "o3-mini": Model(
            id="o3-mini",
            name="o3-mini",
            ...
            context_window=200_000,
            max_tokens=100_000,
            cost=Cost(input=1.10, output=4.40, cache_read=0.55),
        ),
        "o4-mini": Model(
            id="o4-mini",
            name="o4-mini",
