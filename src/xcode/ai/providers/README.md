# Xcode AI Providers — 模型厂商适配器

Providers 层位于 `xcode.ai` 内部，专注于解决：**如何将各大模型提供商特有的请求参数、端点差异及 SSE 流式协议，适配到统一的 Provider 抽象与 `ProviderEvent` 事件流。**
...
### 核心类型与组件
- **Provider 基类 ([base.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/providers/base.py))**：定义模型交互协议与接口规范。
- **厂商适配器**：
...
- **注册与工厂 ([registry.py](file:///C:/Users/dwei/workspace/xcode/src/xcode/ai/providers/registry.py))**：
